...
const command: Command = {
	data: new SlashCommandBuilder()
		...
		.addChannelOption((option) => option.setName('channel').setDescription('The voice channel to use as the queue').addChannelTypes(ChannelType.GuildVoice).setRequired(true))
